...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
class Sessions:
  def __init__(self, db_config:dict, secret_key:str, expiry:int=3600000000000) -> None:
    self.expiry = expiry
...
class SessionStore:
  ...
  def create(self, session_id:str, session_data:dict) -> None:
    ...
    cursor = db.cursor()
    print("about to insert data into session")
    print(session_id)
  ...
  def read(self, session_id:str) -> dict:
    ...
    if result is None:
      print("stop at line 84 sessiondb.py")
      return {}
    ...
    if elapsed > self.expiry:
      ...
      print("stop at line 91 sessiondb.py")
      return {}
